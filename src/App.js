...
import "./App.css"; //load the css after the bootstap
...
const App = () => {
  ...
  const checkIsWinner = () => {
    ...
    if (flag === 1 && itemArray.every(isEmpty)) {
      return toast("DRAW!", { type: "error" });
    }
  };
          ...
          <div className="grid">
            {itemArray.map((item, index) => (
              <Card color="warning" onClick={() => changeItem(index)}>
                {/*here if changeItem is called diretly click happens automtic*/}
